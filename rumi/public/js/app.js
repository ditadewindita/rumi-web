angular.module('Rumi', ['ngRoute', 'Rumi.services', 'Rumi.controllers']).config(function($routeProvider, $locationProvider) {
    ...
    $routeProvider
        ...
        .when('/login', {
            ...
            controller: 'LoginController' //resolveController('/controllers/login.js')
        })

        .when('/register', {
            templateUrl: '../views/register/index.html',
            controller: 'RegisterController' //resolveController('/controllers/register.js')
        });
